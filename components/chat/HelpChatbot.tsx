...
const WELCOME_MESSAGE: Message = {
  id: 'welcome',
  role: 'assistant',
  content: "Hi! I'm your NutraConnect assistant. How can I help you today?",
  timestamp: new Date(),
};
...
export function HelpChatbot() {
  ...
  // Hide on knowledge page (it has its own chat)
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <div
        className={cn(
          'absolute bottom-20 right-0 w-[380px] max-h-[500px] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 flex flex-col overflow-hidden',
      ...
      >
        ...
        <div className="px-4 py-3 bg-gradient-to-r from-teal-500 to-emerald-500 text-white flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-sm">NutraConnect Help</h3>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3 min-h-[300px] max-h-[350px]">
          {messages.map((message) => (
            ...
            >
              ...
              >
                <p className="text-sm whitespace-pre-wrap leading-relaxed">{renderMessageWithLinks(message.content)}</p>
              </div>
            </div>
          ))}
        ...
        <div className="p-3 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
          <div className="flex gap-2">
            ...
            <Button
              ...
              className="bg-teal-500 hover:bg-teal-600 h-9 w-9"
              size="icon"
            >
      ...
      {/* "How can I help you?" Popup - only when closed */}
      {!isOpen && (
        <div
          className="absolute bottom-16 right-0 animate-fade-in cursor-pointer"
        ...
        >
          <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 px-4 py-3 flex items-center gap-2 hover:shadow-xl transition-shadow">
            <div className="h-8 w-8 rounded-full bg-gradient-to-r from-teal-500 to-emerald-500 flex items-center justify-center flex-shrink-0">
